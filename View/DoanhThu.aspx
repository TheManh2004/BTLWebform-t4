            ...
            <div class="menu-container">
                ...
                <div class="table-container">
                    <asp:GridView ID="revenueGridView" runat="server" AutoGenerateColumns="false" CssClass="revenue-table"
                       ...
                       <asp:BoundField DataField="TotalRevenue" HeaderText="Doanh thu" DataFormatString="{0:N0} đ" HtmlEncode="false" />
                            <asp:BoundField DataField="TotalOrders" HeaderText="Số hóa đơn" />
                        </Columns>
                    </asp:GridView>
